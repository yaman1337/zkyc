...
export default function Home() {
  ...
  const endpoint = useMemo(() => "https://devnet.helius-rpc.com?api-key=f9d2c042-b32b-4e1d-a1c8-a59ee7eae324", []);
...
const SendButton: FC = () => {
  ...
  const onClick = useCallback(async () => {
    ...
    const connection: Rpc = createRpc("https://devnet.helius-rpc.com?api-key=f9d2c042-b32b-4e1d-a1c8-a59ee7eae324", "https://devnet.helius-rpc.com?api-key=f9d2c042-b32b-4e1d-a1c8-a59ee7eae324");
    ...
    console.log(
      `Sent ${1e7} lamports to ${recipient.toBase58()} ! txId: https://explorer.solana.com/tx/${signatureSend}?cluster=devnet`
    );
